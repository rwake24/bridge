  ...
  switch (parsed.command) {
    ...
    case 'help': {
      ...
      const common = [
        ...
        '`/schedule enable|disable <id>` — Enable or disable a job',
      ...
      return {
        ...
        response: [
          ...
          '`/remember` — Approve pending permission and save rule',
          '`/rules` — Show all permission rules (alias: `/rule`)',
          '`/rules clear [spec]` — Clear rules (all or specific)',
          '`/yolo` — Toggle auto-approve permissions (no SDK mode change)',
          '`/autopilot` — Toggle autopilot mode (autonomous agentic loop, alias: `/auto`)',
          '',
          '**Scheduling**',
          '`/schedule list` — List scheduled tasks (aliases: `/schedules`, `/tasks`)',
          '`/schedule enable <id>` — Enable a scheduled job',
          '`/schedule disable <id>` — Disable a scheduled job',
          ...
          '',
          '**Tools & Info**',
          '`/skills` — Show available skills and MCP tools (alias: `/tools`)',
